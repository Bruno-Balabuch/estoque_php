...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="h4 mb-0">Editar Categoria</h2>
</div>
            ...
            <div class="card-body">
                <form action="index.php?controller=categoria&action=update&id=<?php echo $categoria['id']; ?>" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nome" class="form-control" value="<?php echo $categoria['nome']; ?>" required>
                    </div>
...
<?php 
$title = "Editar Categoria - Sistema de Estoque";
