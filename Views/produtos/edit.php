...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="h4 mb-0">Editar Produto</h2>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="index.php?controller=produto&action=update&id=<?php echo $produto['id']; ?>" method="POST">
                    <div class="row">
...
<?php 
$title = "Editar Produto - Sistema de Estoque";
